 ...
 * 2, 3 and 4 received: it is composed from docs/design-references/style-guide.md and the token
 ...
 * core-listening scope plan § Standing constraints asks for and which the suite drives directly.
 *
